...
<RelatedLink href="https://move-book.com/" label="The Move Book" desc="A comprehensive guide to the Move programming language and the Sui blockchain." />
