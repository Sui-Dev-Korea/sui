...
- Black(`#000000`) 또는 Gray 500(`#6C7584`) fill 위에는 white text를 선호한다. Sui Blue 500(`#FFFFFF`) 위의 White(`#298DFF`)는 약 3.31:1 contrast를 달성하므로 3:1 graphic AA threshold를 통과하며 허용된다.
