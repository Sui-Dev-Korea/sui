...
구성 옵션(`[ingestion]`, `[committer]`, `[pipeline.<name>]`)은 indexer framework의 표준 설정과 동일하다. 전체 참조는 [Pipeline architecture: Performance tuning](/develop/accessing-data/custom-indexer/pipeline-architecture#performance-tuning)을 참고한다.
