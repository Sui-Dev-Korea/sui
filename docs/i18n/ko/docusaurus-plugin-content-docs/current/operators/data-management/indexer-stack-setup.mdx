...
| `<REMOTE_STORE_URL>` | indexing에 사용할 checkpoint bucket URL이다. 가능한 여러 [data sources](/develop/accessing-data/custom-indexer/custom-indexers#data-sources) 중 하나를 사용한다. |
