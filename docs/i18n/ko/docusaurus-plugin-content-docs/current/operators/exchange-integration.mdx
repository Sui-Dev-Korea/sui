...
Sui GitHub repository의 Docker 또는 source code를 사용해 풀 노드를 설정하고 구성하는 방법은 [Sui 풀 노드 구성](/operators/full-node/sui-full-node)을 참조한다.
...
## event로 address의 balance change 추적
...
서명 유효성 요구 사항에 대한 자세한 내용은 [서명 요구 사항](/develop/transactions/transaction-auth/auth-overview#signature-requirements)을 참고한다.
