...
부모 object는 [shared, owned, party, 또는 wrapped](/develop/objects/object-ownership)일 수 있다.
...
<RelatedLink to="/develop/objects/dynamic-fields" />
<RelatedLink to="/develop/objects/object-ownership" />
<RelatedLink to="/develop/objects/transfers/transfer-to-object" />
