...
### shared object에서 object 받기 {#receive-shared-example}
...
### object를 받아 dynamic field로 추가 {#simple-account}
...
## Soulbound object {#soul-bound-example}
