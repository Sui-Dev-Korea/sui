...
3. digest를 서명자의 해당 체계에 대한 서명 API에 전달한다. 지원되는 서명 방식은 순수 Ed25519, ECDSA Secp256k1, ECDSA Secp256r1이다. 각 서명 방식의 요구사항은 [서명 요구 사항](/develop/transactions/transaction-auth/auth-overview#signature-requirements)을 참조한다.
