...
- [smart contract](/getting-started/onboarding/hello-world) 코드의 의도치 않은 logic traps, 예를 들어 [sponsored transactions](/develop/transaction-payment/sponsor-txn#client-equivocation)을 처리할 때.
