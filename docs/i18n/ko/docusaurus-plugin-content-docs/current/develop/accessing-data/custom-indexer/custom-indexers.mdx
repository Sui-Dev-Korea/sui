...
애플리케이션 전용 데이터를 위한 자체 pipelines를 구축하려면 [커스텀 인덱서 만들기](/develop/accessing-data/custom-indexer/build)를 참조한다. 필요에 맞는 구성이 이미 준비되어 있을 수 있으므로 [data indexer operator](/references/awesome-sui)에 문의할 수도 있다.
