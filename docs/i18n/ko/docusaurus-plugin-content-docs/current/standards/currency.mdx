...
[Closed-Loop Token standard](/standards/closed-loop-token.mdx)를 사용하여 Sui에서 생성된 fungible token의 경우, 문서는 _tokens_라는 용어를 사용한다. 실제로는 이 두 object에 대한 용어가 종종 서로 바꿔서 사용된다.
...
SUI 네이티브 currency와 네트워크에서의 사용에 대해 더 알아보려면 [Sui 토크노믹스](/concepts/tokenomics)를 참조한다.
