...
Flash loan은 pool에서의 대출과 상환이 하나의 programmable transaction block 안에서 수행되는 대출이다. SDK는 이 기능을 구현할 수 있는 함수를 제공한다. API에 대한 자세한 내용은 [플래시 론](../deepbookv3/contract-information/flash-loans.mdx)를 참조하라.
