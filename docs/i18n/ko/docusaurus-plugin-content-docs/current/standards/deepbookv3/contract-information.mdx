...
Taker와 maker fee는 governance proposal에 따라 바뀔 수 있다. governance process를 통해 fee를 어떻게 조정할 수 있는지에 대한 자세한 내용은 [스테이킹 및 거버넌스](./contract-information/staking-governance.mdx)를 참조하라.
