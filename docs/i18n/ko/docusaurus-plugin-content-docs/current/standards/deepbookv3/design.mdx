...
- `BalanceManager`: 주문 시 사용자 자금의 출처로 사용되며, 하나의 `BalanceManager`를 모든 pool에서 공통으로 사용할 수 있다. 자세한 내용은 [BalanceManager](./contract-information/balance-manager.mdx)를 참고한다.
