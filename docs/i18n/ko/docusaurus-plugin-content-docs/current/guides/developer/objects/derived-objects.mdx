...
부모 object는 [shared, owned, party, 또는 wrapped](/guides/developer/objects/object-ownership)일 수 있다.
...
<RelatedLink to="/guides/developer/objects/transfers/transfer-to-object.mdx" />
