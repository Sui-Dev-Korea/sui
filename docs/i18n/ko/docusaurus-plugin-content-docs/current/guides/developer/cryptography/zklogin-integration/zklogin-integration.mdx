---
title: zkLogin 통합
slug: /guides/developer/cryptography/zklogin-integration
...
zkLogin은 user salt를 사용해 zkLogin Sui address를 계산한다([definition](/guides/developer/cryptography/zklogin-integration/) 참조).
