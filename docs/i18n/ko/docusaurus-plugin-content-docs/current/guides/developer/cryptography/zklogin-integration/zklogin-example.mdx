...
zero-knowledge proof(ZK proof)의 획득은 [zkLogin 통합](/guides/developer/cryptography/zklogin-integration/) 문서에 설명된 Mysten Labs-maintained proving service를 호출하여 수행된다.
