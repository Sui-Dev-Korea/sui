...
- [Sui 주소 만들기](/guides/developer/getting-started/get-address.mdx)
...
- [resource safety](/guides/developer/getting-started/hello-world.mdx#resource-safety)에 대해 더 알아본다.
...
- [Sui 설치](/guides/developer/getting-started/sui-install.mdx)
...
- [Sui 클라이언트 설정](/guides/developer/getting-started/configure-sui-client.mdx)
...
- [트랜잭션 서명 및 전송](/guides/developer/transactions/ptbs/sign-and-send-txn)
...
- [equivocation 피하기](/concepts/sui-architecture/epochs.mdx)
...
- [Faucet에서 SUI 받기](/guides/developer/getting-started/get-coins.mdx)
