...
Sui [Closed-Loop Token](/standards/closed-loop-token.mdx) standard를 사용하면, 항공사가 항공권이나 업그레이드를 구매하도록 상용 고객에게 token을 지급하고 싶어 하는 경우처럼, 특정 service에 대해서만 유효한 token을 생성할 수 있다. 
