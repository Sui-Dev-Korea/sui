...
이 명령이 `sui not found`를 반환하면 Sui가 설치되지 않은 것이므로 [Sui 설치](/guides/developer/getting-started/sui-install.mdx)를 먼저 진행한다.
...
Sui address, 키 생성, 복구 구문에 대해 [Learn more](/guides/developer/getting-started/get-address.mdx).
...
[Sui 주소 만들기](/guides/developer/getting-started/get-address.mdx)에서 Sui address에 대해 더 알아본다.
