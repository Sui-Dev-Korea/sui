...
- 첫 번째 코인을 제외한 나머지 코인들은 삭제되며, 이 과정에서 스토리지 리베이트(storage rebate)가 발생할 수 있다.
...
병합은 항상 발생하기 때문에, 스토리지 리베이트로 인해 Transaction이 가스를 소진하면서도 순 환급(net refund)을 발생시키는 특이한 결과가 생길 수 있다.
