...
- Concepts: [래핑된 객체](/guides/developer/objects/versioning.mdx#wrapped-objects)
...
- Concepts: [공유 객체](/guides/developer/objects/object-ownership/shared)
...
- Guide: [이벤트 사용하기](/guides/developer/accessing-data/using-events.mdx)
...
Testnet account에서 SUI를 얻는 다른 방법은 [Faucet에서 SUI 받기](/guides/developer/getting-started/get-coins)를 참조한다.
