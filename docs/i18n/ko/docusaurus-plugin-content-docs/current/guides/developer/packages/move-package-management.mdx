...
이전 system 문서는 [자동 주소 관리](/guides/developer/packages/automated-address-management.mdx)를 참조하고, 차이점과 새 system으로 마이그레이션하는 방법은 [패키지 관리 마이그레이션](/references/package-managers/package-manager-migration.mdx)을 참조한다.
...
자세한 내용은 [PTB 구성하기](/guides/developer/transactions/ptbs/building-ptb)를 참조한다.
