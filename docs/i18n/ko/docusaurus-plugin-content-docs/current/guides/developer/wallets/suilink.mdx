...
- **Cross-chain identity verification**: [Ethereum에서 Sui로](/concepts/sui-for-ethereum.mdx), [Solana에서 Sui로](/concepts/sui-for-solana.mdx), 그리고 다른 Sui address의 wallet을 기본 Sui wallet에 연결한다.
- **Non-transferable proof of ownership**: wallet 소유권을 암호학적으로 검증하는 [soulbound NFT](/guides/developer/nft-soulbound)를 받는다.
...
더 자세한 내용은 [SuiPlay0X1 SuiLink integration guide](/guides/suiplay0x1/wallet-integration.mdx#suilink)를 참조한다.
...
- [지갑 통합 옵션](/guides/suiplay0x1/wallet-integration): SuiPlay0X1용 wallet 전략에 대한 종합 가이드
