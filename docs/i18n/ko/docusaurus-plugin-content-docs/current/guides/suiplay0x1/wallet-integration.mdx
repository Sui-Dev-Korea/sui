...
Playtron 지갑 앱에 온보딩된 SuiPlay0X1 사용자에게는 SuiLink 연결이 자동으로 설정된다. 사용자가 특정 자산을 소유하는지 검증하려면 사용자의 SuiLink object를 조회할 수 있다. 자세한 내용은 [SuiLink](/guides/developer/wallets/suilink.mdx)를 참조한다.
