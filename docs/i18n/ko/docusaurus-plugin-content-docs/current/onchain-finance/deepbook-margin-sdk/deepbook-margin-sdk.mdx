...
referral을 mint하려면, core DeepBook SDK의 `mintReferral` 함수를 사용한다. referral의 mint 및 관리에 대한 자세한 내용은 [DeepBookV3 SDK documentation](/onchain-finance/deepbookv3-sdk#referral-functions)을 참조한다.
