...
[Closed-Loop Token standard](/onchain-finance/closed-loop-token/)를 사용하여 Sui에서 생성된 fungible token의 경우, 문서는 _tokens_라는 용어를 사용한다. 실제로는 이 두 object에 대한 용어가 종종 서로 바꿔서 사용된다.
...
- **One-Time Witness (OTW) creation:**
    ...
    자세한 내용은 [coin finalization 마무리](#coin-finalization-마무리)를 참조한다.
