...
order 배치는 모든 DeepBook 통합의 주요 기능이다. 하지만 order를 배치하기 전에 먼저 balance manager를 설정해야 한다. balance manager 설정에 대한 정보는 [DeepBookV3 SDK](/onchain-finance/deepbookv3-sdk)를 참조한다.
