...
Sui [Closed-Loop Token](/onchain-finance/closed-loop-token/index) standard를 사용하면, 플레이어의 행동에 대해 지급하거나 구매할 수 있게 만들 수 있는 in-game currency(모바일 게임의 gem이나 diamond와 같은)를 생성할 수 있다.
