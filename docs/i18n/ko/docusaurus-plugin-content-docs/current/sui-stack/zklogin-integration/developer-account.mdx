...
![1](../../develop/cryptography/images/zklogin-facebook1.png 'Sign up for Facebook developer account')

_Facebook developer account에 가입한다_

![2](../../develop/cryptography/images/zklogin-facebook2.png 'Go to Settings')
...
![1](../../develop/cryptography/images/zklogin-twitch1.png "Sign up for Twitch developer account")

_Twitch developer account에 가입한다_

![2](../../develop/cryptography/images/zklogin-twitch2.png "Go to Console")
...
![1](../../develop/cryptography/images/zklogin-kakao1.png "Add applications to Kakao")

_Kakao에 application을 추가한다_

1. **App Keys**로 이동하면 플랫폼별 해당 client ID를 찾을 수 있다.

- Native app key: Android 또는 iOS SDK로 API를 호출할 때 사용한다.
- JavaScript key: JavaScript SDK로 API를 호출할 때 사용한다.
- REST API key: REST API로 API를 호출할 때 사용한다.

![2](../../develop/cryptography/images/zklogin-kakao2.png "Find Client ID")
...
![1](../../develop/cryptography/images/zklogin-kakao3.png "Set Redirect URL")
...
1. Slack developer account를 등록한다. [dashboard](https://api.slack.com/apps)에 접근하고 **Create New App**으로 이동한 다음 **From scratch**를 선택한다.
	...
	![1](../../develop/cryptography/images/zklogin-slack1.png "Create app in Slack")

	_Slack에서 app을 생성한다_

1. **App Credentials** 아래에서 Client ID와 Client Secret을 찾는다.

	![1](../../develop/cryptography/images/zklogin-slack2.png "Find Client ID and Client Secret")
...
1. **Features** 아래의 **OAuth & Permissions**에서 Redirect URL을 설정한다. 이는 wallet 또는 application frontend여야 한다.
	...
	![1](../../develop/cryptography/images/zklogin-slack3.png "Set Redirect URL")
...
1. [Apple developer account](https://developer.apple.com/)를 등록한다. **Certificates, Identifiers and Profiles** 섹션으로 이동한다.
	...
	![1](../../develop/cryptography/images/zklogin-apple1.png "Click on Certificates, Identifiers and Profiles")
...
1. App ID를 생성한다.
	...
	![1](../../develop/cryptography/images/zklogin-apple2.png "Create an App ID")
...
1. Services ID를 생성한다.
	...
	![1](../../develop/cryptography/images/zklogin-apple3.png "Create a Services ID")
...
1. 새 identifier를 생성하고 identifier type으로 **Services IDs**를 선택한다.
	...
	![1](../../develop/cryptography/images/zklogin-apple4.png "Set Redirect URL")
