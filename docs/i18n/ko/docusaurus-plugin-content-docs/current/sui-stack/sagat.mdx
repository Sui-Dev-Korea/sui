...
애플리케이션의 frontend 역시 Mysten Labs 서비스로 호스팅되며, 사용자는 이 서비스가 안전하다고 신뢰해야 한다. web interface만 보지 말고 wallet과 같은 2차 위치에서 transaction preview를 항상 검증한다.
...
각 작업은 [programmatically](#using-sagat-programmatically)도 실행할 수 있다.
