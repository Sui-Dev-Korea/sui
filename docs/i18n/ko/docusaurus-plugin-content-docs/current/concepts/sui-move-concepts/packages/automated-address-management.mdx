...
- 키-값 쌍은 [adopting automated address management](#adopting-automated-address-management)에서 설명된 데이터에 해당한다. 이 값을 수정하려면 `sui move manage-package` 명령을 프론트엔드로 사용한다.
