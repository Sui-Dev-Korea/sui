...
<importcontent source="crates/sui-protocol-config/src/lib.rs" mode="code" struct="ProtocolConfig"></importcontent>
...
<relatedlink to="/concepts/versioning.mdx"></relatedlink><relatedlink to="/concepts/object-ownership.mdx"></relatedlink><relatedlink href="https://github.com/MystenLabs/sui/blob/main/crates/sui-protocol-config/src/lib.rs" label="`sui-protocol-config`" desc=" Crate that defines the `ProtocolConfig` struct with limit definitions."></relatedlink><relatedlink href="https://move-book.com/guides/building-against-limits.html" label="Building against Limits" desc=" The Move Book provides a concise overview for limits most projects deal with."></relatedlink><relatedlink href="https://move-book.com/" label="The Move Book" desc=" A comprehensive guide to the Move programming language used on the Sui network."></relatedlink><relatedlink href="https://move-book.com/reference/" label="The Move Reference" desc=" Reference guide for the Move language."></relatedlink>
