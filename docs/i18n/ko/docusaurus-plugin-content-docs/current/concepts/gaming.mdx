...
<RelatedLink to="/standards/coin.mdx" /><RelatedLink to="/guides/developer/coin.mdx" /><RelatedLink to="/guides/developer/nft.mdx" /><RelatedLink to="/guides/developer/nft/asset-tokenization.mdx" /><RelatedLink to="/guides/developer/nft/nft-rental.mdx" /><RelatedLink to="/standards/kiosk.mdx" /><RelatedLink to="/standards/kiosk-apps.mdx" /><RelatedLink to="/concepts/cryptography/zklogin.mdx" /><RelatedLink href="https://blog.sui.io/tag/gaming/" label="Sui Foundation blog" desc="Blog posts from the Sui Foundation with the `gaming` tag." /><RelatedLink to="/guides/developer/app-examples/coin-flip.mdx" /><RelatedLink to="/guides/developer/app-examples/blackjack.mdx" /><RelatedLink to="/guides/developer/app-examples/plinko.mdx" /><RelatedLink href="https://github.com/MystenLabs/mysticon-legends" label="Mysticon Legends" desc="GitHub repo for a blockchain-based game where players collect, train, and battle with mythical creatures called Mysticons." /><RelatedLink href="https://mini-games.sui.io/" label="Web3 Mini Games built on Sui" desc="A collection of mini games, to inspire the community of Sui." />
