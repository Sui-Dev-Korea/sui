...
<RelatedLink to="/concepts/sui-architecture/transaction-lifecycle.mdx" /><RelatedLink to="/concepts/sui-architecture/sui-security.mdx" /><RelatedLink href="https://docs.sui.io/paper/mysticeti.pdf" label="MYSTICETI: Reaching the Latency Limits with Uncertified DAGs" desc="Whitepaper that documents the Mysticeti protocol." />
